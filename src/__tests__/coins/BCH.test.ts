...
const cashAddressTxData = {
  ...
  outputs: [
    ...
    {
      address: 'qpfs2gcfwg322segkj4h30du4vtjyvsxtq6msk90a5',
      value: 100000,
    },
  ],
};
...
describe('coin.BCH', () => {
  ...
  it('should generate the transaction sync to cashAddress', async () => {
    const result = bch.generateTransactionSync(cashAddressTxData, [kpSync]);
    expect(result.txId).toEqual(
      '2347c3307db78ba5efda4a6a283abf8e5e2f7b700f42513c12371afa211f6ea7',
    );
    expect(result.txHex).toEqual(
