...
describe('coin.ETH', () => {
  ...
  it('should generate erc20 data', () => {
    const data = eth.generateTokenTransferData(
      '0xE410157345be56688F43FF0D9e4B2B38Ea8F7828',
      '100000',
      '0xdac17f958d2ee523a2206206994597c13d831ec7',
    );
    expect(data).toBe(
      '0xa9059cbb000000000000000000000000e410157345be56688f43ff0d9e4b2b38ea8f782800000000000000000000000000000000000000000000000000000000000186a0',
    );
    const tokenData = eth.decodeTokenTransferData(
      'a9059cbb000000000000000000000000e410157345be56688f43ff0d9e4b2b38ea8f782800000000000000000000000000000000000000000000000000000000000186a0',
    );
