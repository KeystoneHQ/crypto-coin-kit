import {AddressType, BTC, NetWorkType, TxData} from '../../../BTC';
import keyProvider from '../../../BTC/keyProvider';
import * as bitcoin from 'bitcoinjs-lib';
import {mnemonicToSeedSync} from 'bip39';
import {KeyProviderSync} from "../../../Common/sign";
...
describe('coin.BTC', () => {
    ...
    it('should generate the transaction', async () => {
        ...
        expect(result.txId).toEqual(
            '192d654d1ed06bd99ca39b16ab1b23c7833d46d0bb5b6cf9d6cdebea03fd552e',
        );
        expect(result.txHex).toEqual(
            ''
        );
    });
    ...
    it('should generate the transaction with locktime and version 1', async () => {
        ...
        const result = await xtn.generateTransaction(txData, [kp1, kp2]);
        expect(result.txId).toEqual(
            'fc94ff5395dd520cc9cd3ef0256c38c5bdcea5fd9c66f0144ea145b5381585d9',
        );
        expect(result.txHex).toEqual(
            ''
        );
    });
    ...
    it('parse psbt with both witnessUtxo and nonWitnessUtxo', () => {
        const s =
            '';
        expect(() =>
            btc.parsePsbt(Buffer.from(s, 'hex').toString('base64')),
        ).not.toThrow();
    });
    ...
    it("should test xtn generate p2pkh transaction", () => {
        const mnemonic = "abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about";
        const seed = mnemonicToSeedSync(mnemonic);
        const root = bitcoin.bip32.fromSeed(seed);
        const key = root.derivePath("m/44'/1'/0'/0/0");
        const signer: KeyProviderSync = {
            publicKey: key.publicKey.toString('hex'),
            sign: (hex: string) => {
                try {
                    const input = Buffer.from(hex, 'hex');
                    const sigObj = key.sign(input);
                    const r = sigObj.slice(0, 32).toString('hex');
                    const s = sigObj.slice(32, 64).toString('hex');
                    const recId = sigObj[64];
                    return {
                        r,
                        s,
                        recId,
        ...
        const txData: TxData =
            {
                "inputs": [{
                    "hash": "8b7b1ac5734ff29638e765541e2bbce442d9400ac00bcf9c0a9dda74784c8354",
                    "index": 0,
                    "utxo": {
                        "publicKey": "02a7451395735369f2ecdfc829c0f774e88ef1303dfe5b2f04dbaab30a535dfdd6",
                        "value": 64334
                    },
                    "bip32Derivation": []
                }],
                "outputs": [{
                    "address": "mm6DFdkFiUqv5FongAgoyjsnWhiekSRpCg",
                    "value": 10000,
                }, {
                    "address": "mqvrYyhGRCueNBCEcAy92EC4hR7FkYzDKc",
                    "value": 48000,
                }],
                scriptType: AddressType.P2PKH,
            }
        expect(xtn.generateTransactionSync(txData, [signer])).toStrictEqual({
            txId: '7a541058b54fcdc9c13b877c6aa936937c4167777ef329c7fd6466b9598ef521',
            txHex: ''
        })
    });
});
